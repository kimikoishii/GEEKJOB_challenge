<%-- 
    Document   : DB_018_03_11
    Created on : 2018/01/12, 16:37:24
    Author     : guest1Day
--%>
...
<html>
    ...
    <body>
        ...
        <form action="/servlet_challenge/DB_018_03_11" method="post">

            指定したユーザーの情報を上書きします。<br>
            IDを入力してください。（必須）<br>
            <label><input type="number" name="userID" min ="1" value="" 
                          style="width:50px;" required></label>
            <br>＊＊＊＊＊＊＊＊＊＊＊＊＊＊＊＊＊＊＊<br>
            上書きしたいユーザー情報を入力してください。
            <br>
            <label>名前
                <br>
