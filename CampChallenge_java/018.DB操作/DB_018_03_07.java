 ...
 * @author guest1Day
 */
public class DB_018_03_07 extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet DB_018_03_07</title>");            
            out.println("</head>");
            out.println("<body>");
            ...
            try {
                ...
                String sql = "update user set name=?,age=?,birthday=? where userID =?";        
                ps = con.prepareStatement(sql);
                ps.setString(1, "松岡 修造");//name
                ps.setInt(2, 48);//age
                ps.setDate(3, java.sql.Date.valueOf("1967-11-06"));//birthday
                ps.setInt(4, 1);//userID
                ...
                ps = con.prepareStatement("select * from user where age = ?");
